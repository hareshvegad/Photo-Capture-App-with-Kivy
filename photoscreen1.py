...
<ButtonsLayout1>:
    ...
    Button:
        ...
        height: self.width
        width: self.height
        background_normal: 'camera-flip-outline.png'
        background_down:   'camera-flip-outline.png'
    Button:
        id:flash
        on_press: root.flash()
        height: self.width
        width: self.height
        background_normal: 'flash-off.png'
        background_down:   'flash-off.png'
    Button:
        id:photo
        on_press: root.photo()
        height: self.width
        width: self.height
        background_normal: 'camera_white.png'
        background_down:   'camera_red.png'
"""
...
class ButtonsLayout1(RelativeLayout):
    ...
    def flash(self):
        ...
        if icon == 'on':
            self.ids.flash.background_normal ='flash.png'
            self.ids.flash.background_down   ='flash.png'
        elif icon == 'auto':
            self.ids.flash.background_normal ='flash-auto.png'
            self.ids.flash.background_down   ='flash-auto.png'
        else:
            self.ids.flash.background_normal ='flash-off.png'
            self.ids.flash.background_down   ='flash-off.png'
